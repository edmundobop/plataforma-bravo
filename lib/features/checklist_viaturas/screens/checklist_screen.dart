...
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:gestaocbmgo/features/checklist_viaturas/models/vehicle_checklist.dart';
import 'package:gestaocbmgo/features/checklist_viaturas/models/checklist_category.dart';
import 'package:gestaocbmgo/features/checklist_viaturas/utils/app_colors.dart';
import 'package:gestaocbmgo/features/checklist_viaturas/widgets/category_card.dart';
import 'package:gestaocbmgo/features/checklist_viaturas/widgets/progress_indicator_widget.dart';
import 'category_detail_screen.dart';
import 'signature_screen.dart';
...
class _ChecklistScreenState extends State<ChecklistScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Header com informações da viatura
          Container(
            width: double.infinity,
            decoration: const BoxDecoration(
              color: AppColors.primaryRed,
            ...
            child: Column(
              children: [
                ...
                ProgressIndicatorWidget(
                  progress: _checklist.overallCompletionPercentage / 100,
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                ..._checklist.categories.map((category) {
                  return Padding(
                    padding: const EdgeInsets.only(bottom: 12),
                    child: CategoryCard(
                      category: category,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          maxLines: 4,
                          decoration: InputDecoration(
                            hintText: 'Adicione observações gerais sobre a viatura...',
                            border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(8),
                            ),
                            focusedBorder: OutlineInputBorder(
                ...
                Center(
                  child: Text(
                    'Data: ${DateFormat('dd/MM/yyyy - HH:mm').format(_checklist.date)}',
                    style: const TextStyle(
                      color: AppColors.textSecondary,
                      fontSize: 14,
                    ),
